    ...
    return(
        ...
        <div className="flex items-center justify-center w-full h-full py-24 sm:py-8 px-4">
          {/* Carousel for desktop and large size devices */}
           {/* <CarouselProvider className="lg:block hidden" naturalSlideWidth={100} naturalSlideHeight={125} isIntrinsicHeight={true} totalSlides={6} visibleSlides={2} step={1} infinite={true}>
                                    ...
                                    <Slide index={0}>
                                        <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                                            ...
                                            <div className="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6">
                                                <h2 className="lg:text-xl leading-4 text-base lg:leading-5 text-white">HUGE</h2>
           ...
           <CarouselProvider
            ...
            infinite={true}
          >
            <div className="w-full relative flex items-center justify-center lg:gap-8 md:gap-6 gap-14">
              <ButtonBack
                role="button"
              ...
              <div className="w-full h-full mx-auto overflow-x-hidden overflow-y-hidden">
                <Slider className="lg:gap-8 md:gap-6 gap-14">
                  

                  <Slide index={0}>
                    <div className="flex flex-shrink-0 relative w-full sm:w-auto lg:gap-8 md:gap-6 gap-14">
                      <img
          ...
          >
            <div className="w-full relative flex items-center justify-center">
              ...
              <div className="w-full h-full mx-auto overflow-x-hidden overflow-y-hidden px-12">
                <Slider>
                  <div
                    id="slider"
          ...
          >
            <div className="w-full relative flex items-center justify-center">
              ...
              <div className="w-full h-full mx-auto overflow-x-hidden overflow-y-hidden">
                <Slider className="px-14">
                
                    <Slide index={0}>
                      <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                        <img
                          src="https://i.ibb.co/ScPBxm3/p1.jpg"
                          alt="black chair and white table"
                          className="object-cover object-center w-full h-[370px]"
                        />
                        <div className="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6">
                          <h2 className="lg:text-xl leading-4 text-base lg:leading-5 text-white">
                            small
                    ...
                    <Slide index={2}>
                      <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                        <img
                          src="https://i.ibb.co/pdcnQYY/p2.jpg"
                          alt="sitting area"
                          className="object-cover object-center w-full h-[370px]"
                        />
                        <div className="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6">
                    ...
                    <Slide index={4}>
                      <div className="flex flex-shrink-0 relative w-full sm:w-auto">
                        <img
                          src="https://i.ibb.co/99LR3Mt/p3.webp"
                          alt="black chair and white table"
                          className="object-cover object-center w-full h-[370px]"
                        />
                        <div className="bg-gray-800 bg-opacity-30 absolute w-full h-full p-6">
