        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-24 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Visit our location or get in touch through our contact information
            </p>
          </div>

          {/* Map and contact info grid */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Interactive Map - Replacing the email form */}
            <div className="relative h-96 lg:h-full rounded-3xl overflow-hidden shadow-2xl transform transition-all hover:shadow-3xl hover:-translate-y-1 border-4 border-white">
              <iframe
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-6">
                <h3 className="text-white text-xl font-bold">
                  WAVES Creative Studio
                </h3>
                <p className="text-white/90">
                  123 Oceanview Drive, Malibu, CA 90265
                </p>
              </div>
            </div>
